...
hgvs <- get_snp_variations_in_protein_from_snp_id(snp_ids[1])
...
hgvs <- get_snp_variations_in_protein_from_snp_id(snp_ids[5])
tryCatch(is_hgvs_in_tmh(hgvs), error = function(e) print(e))
```
...
```{r}
hgvs <- get_snp_variations_in_protein_from_snp_id(snp_ids[7])
tryCatch(is_hgvs_in_tmh(hgvs), error = function(e) print(e))
```
...
hgvs <- get_snp_variations_in_protein_from_snp_id(snp_ids[8])
in_in_tmh <- NA
